...
<body class="bg-gray-100 font-sans">
    ...
    <main class="container mx-auto mt-8 p-4">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer mb-4">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-center space-x-4 mt-6">
                            <button class="bg-transparent hover:bg-gray-200 rounded-full p-3" title="Edit" onclick="showEditPopup(<?php echo (int)($course['userID'] ?? 0); ?>)">
                                <i class="fas fa-edit text-blue-600 text-xl"></i>
                            </button>
                            <button class="bg-transparent hover:bg-gray-200 rounded-full p-3" title="Delete" onclick="confirmDeleteCourse(<?php echo (int)($course['userID'] ?? 0); ?>)">
                                <i class="fas fa-trash text-red-600 text-xl"></i>
                            </button>
                            <button class="bg-transparent hover:bg-gray-200 rounded-full p-3" title="View Enrollments" onclick="showEnrollmentList(<?php echo (int)($course['userID'] ?? 0); ?>)">
            ...
            <div class="relative bg-white rounded-lg w-full max-w-2xl mx-auto p-8">
                ...
                <form>
                    <div class="mb-6">
                        ...
                        <input type="text" id="edit-course-title" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500">
                    </div>
                    <div class="mb-6">
                        <label for="edit-course-description" class="block text-gray-700 text-sm font-bold mb-2">Course Description:</label>
                        <textarea id="edit-course-description" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500 h-32"></textarea>
                    </div>
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline" onclick="saveChanges()">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const navLinks = document.querySelectorAll('a:not([href="/logout"])');
