...
<body class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="space-x-6">
            <a href="../connection/login.php" class="text-gray-700 hover:text-blue-500">Login</a>
            <a href="../connection/signup.php" class="text-gray-700 hover:text-blue-500">Register</a>
        </div>
    </div>
</nav>
